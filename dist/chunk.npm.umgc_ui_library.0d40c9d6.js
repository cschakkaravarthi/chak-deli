...
var contentWrapper_1 = __webpack_require__("gq5Y");
var cardHelper_1 = __webpack_require__("xuej");
exports.KnowledgeBaseSearchCard = function (props) {
    var date = props.date, title = props.title, MainLink = props.MainLink, authorName = props.authorName, searchSummary = props.searchSummary, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a;
    return (react_1["default"].createElement(contentWrapper_1.ContentWrapper, { title: "", showContentTop: false, topBorder: "darkTurquoise", wrapperClass: "card-knowledge-base-search-result" },
        react_1["default"].createElement("div", { className: "justify-content-between flex-column" },
            react_1["default"].createElement(Card_1["default"].Title, { className: "" }, MainLink && react_1["default"].createElement(MainLink, null, cardHelper_1.highlight(title, searchKeyword))),
...
var react_1 = __importDefault(__webpack_require__("q1tI"));
var Card_1 = __importDefault(__webpack_require__("6xyR"));
var encode_1 = __webpack_require__("EV90");
...
exports.images = {
    ...
    searchIconGrey: __webpack_require__("GyjN"),
    addIcon: __webpack_require__("rVu6"),
    removeIcon: __webpack_require__("1HnH"),
    caretRight: __webpack_require__("g50/"),
    caretLeft: __webpack_require__("WvfA"),
    chevronUp: __webpack_require__("IkjR"),
    chevronDown: __webpack_require__("MyAz"),
    bell: __webpack_require__("TTXS"),
    close: __webpack_require__("OQ3x"),
    calendar: __webpack_require__("KULR"),
    envelope: __webpack_require__("TZns")
};
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 15 15'%3E%3Cdefs%3E%3Cstyle%3E.cls-1%7Bfill:%23a4a3a4;%7D%3C/style%3E%3C/defs%3E%3Ctitle%3Esearch_grey%3C/title%3E%3Cg id='Layer_2' data-name='Layer 2'%3E%3Cg id='Layer_1-2' data-name='Layer 1'%3E%3Cpath id='Path_2' data-name='Path 2' class='cls-1' d='M15,13.3l-4-4A6,6,0,1,0,9.31,11l4,4ZM1.7,6A4.3,4.3,0,1,1,6,10.3H6A4.3,4.3,0,0,1,1.7,6Z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E"
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'%3E%3Cpath d='M240.971 130.524l194.343 194.343c9.373 9.373 9.373 24.569 0 33.941l-22.667 22.667c-9.357 9.357-24.522 9.375-33.901.04L224 227.495 69.255 381.516c-9.379 9.335-24.544 9.317-33.901-.04l-22.667-22.667c-9.373-9.373-9.373-24.569 0-33.941L207.03 130.525c9.372-9.373 24.568-9.373 33.941-.001z'/%3E%3C/svg%3E"
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'%3E%3Cpath d='M12 192h424c6.6 0 12 5.4 12 12v260c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V204c0-6.6 5.4-12 12-12zm436-44v-36c0-26.5-21.5-48-48-48h-48V12c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v52H160V12c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v52H48C21.5 64 0 85.5 0 112v36c0 6.6 5.4 12 12 12h424c6.6 0 12-5.4 12-12z'/%3E%3C/svg%3E"
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'%3E%3Cpath d='M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z'/%3E%3C/svg%3E"
...
exports.ArticleSearchCard = function (props) {
    var title = props.title, content = props.content, MainLink = props.MainLink, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a;
            ...
            react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12", className: "align-items-center d-flex" },
                react_1["default"].createElement(Card_1["default"].Body, { className: "justify-content-between flex-column" },
                    react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12" },
                        react_1["default"].createElement(Card_1["default"].Title, { className: "my-2" }, MainLink && react_1["default"].createElement(MainLink, null, cardHelper_1.highlight(title, searchKeyword))),
...
exports.PageSearchCard = function (props) {
    var title = props.title, departmentName = props.departmentName, searchSummary = props.searchSummary, MainLink = props.MainLink, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a;
    return (react_1["default"].createElement(Card_1["default"], { className: "card-page-search rounded-0 h-100 border-0" },
        react_1["default"].createElement(Row_1["default"], null,
            react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12", className: "align-items-center d-flex" },
                react_1["default"].createElement(Card_1["default"].Body, { className: "justify-content-between flex-column" },
                    react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12" },
                        react_1["default"].createElement(Card_1["default"].Title, { className: "my-2" }, MainLink && react_1["default"].createElement(MainLink, null,
                            " ",
...
exports.TechCatalogSearchCard = function (props) {
    var title = props.title, rate = props.rate, searchSummary = props.searchSummary, MainLink = props.MainLink, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a;
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 15.35 20'%3E%3Cdefs%3E%3Cstyle%3E.cls-1%7Bfill:%23fff;fill-rule:evenodd;%7D%3C/style%3E%3C/defs%3E%3Ctitle%3Ebell%3C/title%3E%3Cg id='Layer_2' data-name='Layer 2'%3E%3Cg id='Layer_1-2' data-name='Layer 1'%3E%3Cpath id='Path_1' data-name='Path 1' class='cls-1' d='M15,7.35v3.46c0,.9.08,2.36.17,3.26l.16,1.44a.72.72,0,0,1-.63.81H.74A.73.73,0,0,1,0,15.62a.41.41,0,0,1,0-.11l.15-1.44c.09-.89.17-2.35.17-3.26V7.35A7.35,7.35,0,1,1,15,7.35ZM4.82,17.14h5.71a2.86,2.86,0,1,1-5.71,0Z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E"
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'%3E%3Cpath d='M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z'/%3E%3C/svg%3E"
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 192 512'%3E%3Cpath d='M192 127.338v257.324c0 17.818-21.543 26.741-34.142 14.142L29.196 270.142c-7.81-7.81-7.81-20.474 0-28.284l128.662-128.662c12.599-12.6 34.142-3.676 34.142 14.142z'/%3E%3C/svg%3E"
...
exports.PeopleSearchCard = function (props) {
    var title = props.title, designation = props.designation, companyName = props.companyName, workLocation = props.workLocation, mail = props.mail, phoneNumber = props.phoneNumber, imageUrl = props.imageUrl, MailLink = props.MailLink, PhoneLink = props.PhoneLink, MainLink = props.MainLink, isCurrentUser = props.isCurrentUser, handleAddToContacts = props.handleAddToContacts, addToContactIcon = props.addToContactIcon, isFetching = props.isFetching, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a;
        ...
        react_1["default"].createElement("div", { className: 'row mr-0 ml-0' },
            ...
            react_1["default"].createElement("div", { className: 'col-12 col-xl-10 p-0 text-break align-items-center d-flex' },
                react_1["default"].createElement(Card_1["default"].Body, { className: 'justify-content-between flex-column pt-0 pl-2 pr-2 pb-2 g700-text-clr' },
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement(Card_1["default"].Text, { className: 'mt-2 mb-0 text-condensed font-size-20' }, !isFetching ? MainLink && react_1["default"].createElement(MainLink, null, cardHelper_1.highlight(title, searchKeyword)) : react_1["default"].createElement(react_loading_skeleton_1["default"], null)),
...
module.exports = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 192 512'%3E%3Cpath d='M0 384.662V127.338c0-17.818 21.543-26.741 34.142-14.142l128.662 128.662c7.81 7.81 7.81 20.474 0 28.284L34.142 398.804C21.543 411.404 0 402.48 0 384.662z'/%3E%3C/svg%3E"
...
exports.DepartmentSearchCard = function (props) {
    var title = props.title, searchSummary = props.searchSummary, MainLink = props.MainLink, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a;
...
exports.OfficeSearchCard = function (props) {
    var title = props.title, officeAddress = props.officeAddress, MainLink = props.MainLink, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a;
    ...
    return (react_1["default"].createElement(Card_1["default"], { className: "card-document-search rounded-0 h-100 border-0" },
        react_1["default"].createElement(Row_1["default"], null,
            react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12", className: "align-items-center d-flex" },
                react_1["default"].createElement(Card_1["default"].Body, { className: "justify-content-between flex-column" },
                    react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12" },
                        react_1["default"].createElement(Card_1["default"].Title, { className: "my-s2" }, MainLink && react_1["default"].createElement(MainLink, null,
                            " ",
                            cardHelper_1.highlight(title, searchKeyword),
                            " ")),
                        react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12", className: "mt-2 p-0 font-weight-lighter" }, searchSummary)),
...
exports.LinkSearchCard = function (props) {
    var title = props.title, searchSummary = props.searchSummary, MainLink = props.MainLink, imageSrc = props.imageSrc, _a = props.imageHeight, imageHeight = _a === void 0 ? 30 : _a, _b = props.imageWidth, imageWidth = _b === void 0 ? 30 : _b, _c = props.searchKeyword, searchKeyword = _c === void 0 ? '' : _c;
    ...
    return (react_1["default"].createElement(Container_1["default"], { className: "card-notification-standard notification-type-" + notificationType + " rounded-0 card border-0 my-3" },
        react_1["default"].createElement(Card_1["default"].Body, null,
            ...
            bodyFull && bodyFull.length > summaryMaxLength ? (react_1["default"].createElement("button", { type: "button", onClick: handleShowMore, className: "card-notification-standard-more font-size-sm mr-4 font-weight-bolder border-0" },
                ...
                react_1["default"].createElement("span", { className: "show-more-arrow pl-2" }, showMore ? (react_1["default"].createElement("img", { src: images_1.images.chevronUp, width: 10, height: 10 })) : (react_1["default"].createElement("img", { src: images_1.images.chevronDown, width: 10, height: 10 }))))) : null,
